...
export default function Home() {
  ...
  function finalCalculation() {
    ...
    const ssf =
      parseInt(formData.citizenInvestmentTrust) +
      parseInt(formData.employeeProvidentFund) +
      parseInt(formData.socialSecurityFund);
  ...
  return (
    <>
            ...
            <div className="box3-1">
              ...
              <div className="bonus">
                ...
                <input
                  ...
                  name="bonus"
                  onChange={setData}
                  onMouseOut={totalSalaryCalculation}
                ></input>
                <br></br>
              </div>
              ...
              <input
                ...
                name="totalSalary"
                placeholder="0"
                onClick={totalSalaryCalculation}
              ></input>
              <br></br>
            </div>
            <div className="box3-2">
              <p>Annual Deduction</p>
              <label>Social Security Fund</label>
              <br></br>
              <input
                type="number"
              ...
              ></input>
              <br></br>
              <label>Employees Provident Fund</label>
              <br></br>
              <input
                type="number"
          ...
          <div className="box4">
            ...
            <Dialog className="dialog" open={open} onOpenChange={setOpen}>
              ...
              <DialogContent className="dialog-content">
                ...
                <DialogDescription>
                  <div className="dialogdiv">
                    <div
                      ...
                      id="monthly"
                      name="monthly"
                      value={(parseFloat(tax) / 12).toFixed(3)}
                    >
                      Rs. {(parseFloat(tax) / 12).toFixed(3)} (Monthly)
                    </div>
                    <div
                      type="text"
                      id="yearly"
                  ...
                  <div className="dbox1">
                    ...
                    <div className="dbox1-1">
                      ...
                      <div className="dinput" id="ssf" name="ssf">
                        Rs. {finalData.SSF}
                      </div>
                    </div>
                    <div className="dbox1-1">
                      <div>Insurance: </div>
                      <div className="dinput" id="ins" name="ins">
                        Rs. {finalData.INS}
                      </div>
                    </div>
                    <div className="dbox1-1">
                      <div>Total Deduction (TD): </div>
                      <div className="dinput" id="TD" name="TD">
                        Rs. {finalData.TD}
                      </div>
                    </div>
                    <div className="dbox1-1">
                      <div>Net Assessable (TI-TD): </div>
                      <div className="dinput" id="NA" name="Na">
                        Rs. {finalData.NA}
                      </div>
                    </div>
                  </div>
                    ...
                    <table id="dialogTable">
                      ...
                      <tbody>
                        ...
                        <tr className="finalRow">
                          <td className="hhh">{finalData.AI}</td>
                          <td className="hhh">{tax}</td>
                          <td></td>
                        </tr>
                        <tr className="finn">
                          <td>Net tax Liability(Monthly): </td>
                          <td>Rs. {(parseFloat(tax) / 12).toFixed(3)}</td>
                          <td></td>
                        </tr>
                        <tr className="finn">
                ...
                <DialogFooter>
                  <button class="printme" onClick={hello}>
                    Print
                  </button>
                  <DialogClose asChild>
                    <button className="clos" onClick={closing}>
                      close
                    </button>
                  </DialogClose>
                </DialogFooter>
      ...
      <div>
        <p className="info">
          Salary tax calculator is designed for calculating tax payable to Nepal
          government on the salary earned in a given year. The calculation is
          based on Nepal Government Tax Policy.
          <br></br>
          If you have any feedback and suggestion, please write to{" "}
          <span
            className="mail"
            onClick={() => {
              router.push("mailto:info@eattendance.com");
            }}
          >
